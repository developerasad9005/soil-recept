document.getElementById("submit").addEventListener("click", function () {
    ...
    let firstPrizeChange = randomNumber(7, 25);
    let secoundPrizeChange = randomNumber(12, 40);
    let thirdPrizeChange = randomNumber(50, 95);
    let cashPrize = randomNumber(160, 170);
